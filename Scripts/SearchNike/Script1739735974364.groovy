...
WebUI.mouseOver(findTestObject('Object Repository/Page_Home Page/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_Home Page/button_Search'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Search results for Nike/div_Your search returned no results.       _84b93f'), 
    0)
